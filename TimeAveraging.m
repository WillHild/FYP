...
timeDataPath = "Timestamp_Current\Coaxial_80bar_Free_Zoom.csv";
...
figure(5);
plot(pressuresAtIntervalTimes, angles, "*");
title("Spray Angle vs Pressure")
xlabel("Pressure (Pa)")
...
plot(intervalTimes, pressuresAtIntervalTimes)
xlabel("Time (s)")
ylabel("Pressure (Pa)")
hold off
